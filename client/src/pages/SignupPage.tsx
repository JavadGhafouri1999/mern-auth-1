...
export default function SignupPage() {
	...
	return (
		<div className="rounded-xl text-gray-300 w-full max-w-5xl backdrop-blur-xs flex justify-between gap-4 mx-5 lg:mx-auto p-4 bg-white/10">
			{/* Right - Form */}
			<div className="min-h-full w-full md:w-1/2 flex flex-col gap-8 p-4 rounded-xl overflow-hidden">
				...
				<form className="h-full flex flex-col items-start gap-8 w-full">
					<div className="flex flex-col gap-4 w-full max-w-xs mx-auto">
						<FormControl>
							<FormLabel className="text-sm text-gray-200">نام کاربری</FormLabel>
							<Input
						...
						<FormControl>
							<FormLabel className="text-sm text-gray-200">تکرار رمز</FormLabel>
							<Input
								placeholder="*********"
								type={showPass ? "text" : "password"}
								variant="soft"
			...
			{/* Left- Image */}
			<div className="hidden min-h-full md:block w-1/2 overflow-hidden rounded-xl">
